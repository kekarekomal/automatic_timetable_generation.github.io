...
$q = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), "SELECT * FROM teachers ");
while ($row = mysqli_fetch_assoc($q)) {
    $query = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), "SELECT * FROM " . $row['faculty_number'] . " WHERE day = '$day'");
