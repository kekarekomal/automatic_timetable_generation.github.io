...
$q = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), "INSERT INTO teachers VALUES ('$facno','$name','$alias','$designation','$contact','$email')");
...
mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), $sql);
