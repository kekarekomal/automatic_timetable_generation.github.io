...
<form action="allotclasses.php" method="post" style="margin-top: 100px">
    ...
    <div align="center">
        <select name="course" class="list-group-item">
            ...
            ';
            <option value="2">B.E 3rd sem</option>
            <option value="3">B.E 4rth sem</option>
            <option value="4">B.E 5th sem</option>
            <option value="2">B.E 6th sem</option>
            <option value="3">B.E 7th sem</option>
            <option value="4">B.E 8th sem</option>
        </select>
    </div>
