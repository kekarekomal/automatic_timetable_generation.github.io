...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 30px">
        <select name="select_teacher" class="list-group-item">
            ...
            <?php
            $q = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"),
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        ...
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), "SELECT * from classrooms
                        WHERE status = '$year'"));
                        echo " ( " . $r['name'], " ) ";
                    } else if (isset($_POST['select_teacher'])) {
                        $id = $_POST['select_teacher'];
                        $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"), "SELECT * from teachers
            ...
            <tr>
                ...
                <td style="text-align:center">1:30-4:30</td>
            </tr>
            <tr>
                <?php
                $table = null;
                ...
                if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_GET['display'])) {
                    $q = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"),
                        "SELECT * FROM" . $table);
                    $qq = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"),
                        ...
                        while ($r = mysqli_fetch_assoc($qq)) {
                            if ($r['isAlloted'] == 1 && $r['semester'] == $_POST['select_semester']) {
                                ...
                                if (isset($r['allotedto'])) {
                                    $id = $r['allotedto'];
                                    $qqq = mysqli_query(mysqli_connect("localhost", "root", "root", "ttms"),
                ...
                <td style=\"text-align:center\">BREAK</td>
                 <td style=\"text-align:center\">{$row['period3']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT, KLE.";
